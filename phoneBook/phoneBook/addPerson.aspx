        ...
        <ContentTemplate>
            ...
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="deleteContactBtn" runat="server" Text="Удалить" CssClass="btn btn-xs btn-warning" CommandName="DeleteContact" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
